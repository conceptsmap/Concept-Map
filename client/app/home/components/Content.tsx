...
const Content = () => {
  return (
    ...
    <section className="flex flex-col items-center justify-center text-center py-20 bg-white">
      ...
      <Button
          className="
            px-4 py-5 text-lg font-bold text-white rounded-lg border-3 border-[#1DBF73]
        ...
        <Button
          className="
            px-6 py-5 text-lg font-bold text-white rounded-lg border-3 border-[#207D3E]
    ...
    <section className="">
      <div className="relative mx-auto rounded-t-[60px]
    rounded-b-none bg-gray-100 p-10 md:p-16 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-24">
          ...
          <div className="text-left">
            ...
            <Button
          className="
            mt-8 px-5 py-5 text-lg font-bold text-white rounded-lg border-3 border-[#207D3E]
            bg-gradient-to-b from-[#73D091] to-[#08501F]
            shadow-[inset_0_0_0_1px_black,0_2px_4px_rgba(0,0,0,0.25)]
             transition-all
          "
        >
          ...
          <div className="relative h-[460px] w-full">
            <div className="absolute -left-35 top-18 z-10 rounded-xl">
              <Image
              width={400}
              src={img3} alt="Script card" className="rounded-xl" />
            </div>

            <div className="absolute -right-25 z-10 top-0 rounded-xl">
              <Image
              width={400}
              src={img2} alt="Script card" className="rounded-xl" />
            </div>

            <div className="absolute right-25 z-0 -top-10 rounded-xl">
              <Image
              width={400}
              height={300}
              src={img1} alt="Script card" className="rounded-xl" />
            </div>
          </div>
