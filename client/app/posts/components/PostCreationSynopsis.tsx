...
export default function PostCreationSynopsis({
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 space-y-6">
      ...
      <div className="space-y-2">
        <Label>Synopsis Content <span className="text-gray-400 text-xs font-normal">(optional)</span></Label>
        <Textarea rows={8} placeholder={`Overview\nA seasoned journalist...\n\nKey Plot Points\n- A cryptic lead\n- A race against time`} value={synopsisContent} onChange={(e) => setSynopsisContent(e.target.value)} />
      </div>
      ...
      <div className="flex items-start gap-2">
        ...
        <Label htmlFor="synopsis-rights" className="text-sm leading-snug">I confirm that I own the rights to this synopsis.</Label>
      </div>
